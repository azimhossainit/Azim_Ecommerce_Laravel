...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            ...
            <x-input label="Short Description" name="short_description" placeholder="Short Description" :required="true" :disabled="false" />
                ...
                <div class="sectionCard mb-5">
                    ...
                    <div class="row mt-3">
                        ...
                        <input type="file" name="thumbnail" id="thumbnail" accept="image/*" class="form-control d-none"
                            ...
                            <div class="upload__box">
                                <div class="upload__btn-box">
                                    <label class="upload__btn" for="upload">
                                        <img src="{{ asset('thumbnail.webp') }}" alt="" class="img-thumbnail"
                                            id="thumbnail_gallery" width="140" height="140">
                                    </label>
                                </div>
...
@push('style')
    ...
    <script>
    function ImgUpload() {
    let dt = new DataTransfer(); // সব ফাইল রাখা হবে
    ...
    if (file.size > maxSize) {
        ...
        input.value = '';
        ImagePrv.src = "{{ asset('thumbnail.webp') }}";
